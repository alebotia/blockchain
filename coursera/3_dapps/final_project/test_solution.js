    ...
    .then(function (result) {
      ...
      */
      ...
      if(e === "Failed to check remaining tokens less than count") {
        ...
        ***********/
        assert(false);// here I need to throw the error, if true keeps it path
      } else {
        /**********
  ...
  it("Should set winners", function() {
    ...
    ***********/
    ...
    .then(function(result) {
      ...
      ***********/
      assert.notEqual(result, '0x0000000000000000000000000000000000000000', 'Error at item 1')
      /**********
      ...
      ***********/
      ...
      HINT:     Default address is '0x0000000000000000000000000000000000000000'
                ...
                Parameters for notEqual : (result, default address , message);
      ***********/
      assert.notEqual(result, '0x0000000000000000000000000000000000000000', 'Error at item 2')
      /**********
      ...
      ***********/
      ...
      HINT:     Default address is '0x0000000000000000000000000000000000000000'
                ...
                Parameters for notEqual : (result, default address , message);
      ***********/
      assert.notEqual(result, '0x0000000000000000000000000000000000000000', 'Error at item 3')
    })
  });
});
